...
/**
 * El tablero del aula, para la pestania «Tablero» de Seguimiento.
 *
 * Era una pagina suelta en /admin/participantes/academico/tablero, y
 * la de al lado --«Avance»-- enseniaba lo mismo persona a persona. Dos
 * entradas de menu para la misma pregunta con distinto zoom: cada una
 * enlazaba a la otra en su propio subtitulo, que es la sennial de que
 * nunca debieron ser dos.
 */
export function TableroAcademico() {
          ...
          <>
            ...
            <div className="mt-6 grid sm:grid-cols-2">
              ...
              <p className="text-xs text-texto-suave">
                ...
                resuelven con dos llamadas distintas. Persona a persona, la lista
                está en la pestaña «Avance».
              </p>
            </div>
          </>
        )}
