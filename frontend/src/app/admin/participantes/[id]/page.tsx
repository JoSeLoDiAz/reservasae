          ...
          <div className="rounded-xl border border-borde bg-superficie-alterna p-4">
            <p className="text-sm text-texto-suave">
              {rui.simulado
                ...
                : /* el motivo de VERDAD, que distingue el portal caido
                     de un navegador que no arranco. Antes aqui iba una
                     frase generica y encima de esta caja habia otra
                     igual: dos grises seguidas diciendo lo mismo. */
                  `${rui.motivoFallo ?? "El RUI no respondió."} El nombre se puede verificar en:`}
            </p>
