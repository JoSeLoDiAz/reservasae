...
/**
 * Panel de seguimiento de Inscripciones.
 *
 * Solo mira: aqui no se cambia la etapa de nadie ni se asigna
 * asesor. Eso vive en Gestion de leads, que es la otra vista
