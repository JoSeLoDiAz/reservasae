<!--
  Copia para grupo-ae. El original vive en la raiz del repositorio,
  en `docs/estilo-del-panel.md`, y lo escribio el equipo de Convoca.

  Esta copia existe porque los agentes que trabajan DENTRO de grupo-ae/
  no alcanzan la raiz, y llevaban un dia entero recibiendo reglas de un
  archivo que no podian abrir: obedecian de memoria lo que yo les
  resumia, que no es lo mismo que leerlo.

  Si el original cambia, esta copia se queda vieja. Es el precio de
  que se pueda leer, y es mejor que no leerlo.
-->
